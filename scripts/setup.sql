-- Setup script for the Data Quality Check application.
CREATE APPLICATION ROLE DATA_GOV_APP;
CREATE SCHEMA IF NOT EXISTS DATA_GOV_METADATA_APP;
CREATE SCHEMA IF NOT EXISTS DATA_GOV_APP;
GRANT USAGE ON SCHEMA DATA_GOV_METADATA_APP TO APPLICATION ROLE DATA_GOV_APP;
GRANT USAGE ON SCHEMA DATA_GOV_APP TO APPLICATION ROLE DATA_GOV_APP WITH GRANT OPTION;
GRANT CREATE TABLE ON SCHEMA DATA_GOV_APP TO APPLICATION ROLE DATA_GOV_APP ;
...
def main(session,db_name,schema_name,table_name):
    try:
        ...
        if  isinstance(metadata_df, type(None)):
...
---Reference Objects in consumer accounts

CREATE PROCEDURE DATA_GOV_METADATA_APP.REGISTER_REFERENCE(ref_name STRING, operation STRING, ref_or_alias STRING)
  RETURNS STRING
  LANGUAGE SQL
  AS $$
    BEGIN
...
GRANT USAGE ON PROCEDURE DATA_GOV_METADATA_APP.create_metadata(VARCHAR,VARCHAR,VARCHAR) TO  APPLICATION ROLE DATA_GOV_APP;
GRANT USAGE ON PROCEDURE DATA_GOV_METADATA_APP.create_dq_rule(VARCHAR,VARCHAR,VARCHAR,VARCHAR) TO  APPLICATION ROLE DATA_GOV_APP;
GRANT USAGE ON PROCEDURE DATA_GOV_METADATA_APP.rundq_rules(VARCHAR,VARCHAR,VARCHAR) TO  APPLICATION ROLE DATA_GOV_APP;
GRANT USAGE ON PROCEDURE DATA_GOV_METADATA_APP.collect_processmetadata(VARCHAR,VARCHAR,VARCHAR) TO  APPLICATION ROLE DATA_GOV_APP;
GRANT USAGE ON PROCEDURE DATA_GOV_METADATA_APP.REGISTER_REFERENCE(STRING, STRING, STRING) TO APPLICATION ROLE DATA_GOV_APP;


grant usage on sequence DATA_GOV_METADATA_APP.DQ_RULES_SEQ  to  APPLICATION ROLE DATA_GOV_APP;
grant usage on sequence DATA_GOV_METADATA_APP.GE_FUNCTION_RULE_MAP_SEQ  to  APPLICATION ROLE DATA_GOV_APP;
grant usage on sequence DATA_GOV_METADATA_APP.PROCESS_METADATA_SEQ  to  APPLICATION ROLE DATA_GOV_APP;
grant usage on sequence DATA_GOV_METADATA_APP.DQ_VIOLATIONS_SEQ  to  APPLICATION ROLE DATA_GOV_APP;

GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.DATASETS TO  APPLICATION ROLE DATA_GOV_APP;
GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.ATTRIBUTES TO  APPLICATION ROLE DATA_GOV_APP;
GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.DQ_RULES TO  APPLICATION ROLE DATA_GOV_APP;
GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.GE_FUNCTION_RULE_MAP TO  APPLICATION ROLE DATA_GOV_APP;
GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.DQ_VIOLATIONS TO  APPLICATION ROLE DATA_GOV_APP;
GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.SENSITIVE_ATTRIBUTES TO  APPLICATION ROLE DATA_GOV_APP;
GRANT SELECT,INSERT,UPDATE ON TABLE DATA_GOV_METADATA_APP.PROCESS_METADATA TO  APPLICATION ROLE DATA_GOV_APP;
